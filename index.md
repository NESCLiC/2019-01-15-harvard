...
helper: ["Ceilyn Boyd", "Cole Crawford", "Julie Goldman", "Jeremy Guillette", "Hugh Truslow"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["ceilyn_boyd@harvard.edu"] or ["truslow@fas.harvard.edu"]   # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
